...
public class AccountManager implements AccountService{
	...
	private final EntityToAccountDtoService entityToAccountDtoService;

	public AccountManager(UserRepository userRepository, ModelMapper modelMapper,
			EntityToAccountDtoService entityToAccountDtoService) {
		this.userRepository = userRepository;
		this.modelMapper=modelMapper;
		this.entityToAccountDtoService=entityToAccountDtoService;
